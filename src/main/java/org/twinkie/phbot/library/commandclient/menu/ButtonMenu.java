...
/**
 * A {@link org.twinkie.phbot.library.commandclient.menu.Menu Menu} implementation that creates
 ...
 * @author John Grosh
 */
public class ButtonMenu extends org.twinkie.phbot.library.commandclient.menu.Menu
{
    ...
    /**
     * Shows the ButtonMenu as a new {@link Message Message}
    ...
    /**
     * The {@link org.twinkie.phbot.library.commandclient.menu.Menu.Builder Menu.Builder} for
    ...
    public static class Builder extends Menu.Builder<Builder, ButtonMenu>
    {
         ...
         *
         * <p>Any non-unicode {@link Emoji Emote} should be
         * added using {@link Builder#addChoice(Emoji)
        ...
        /**
         * Adds a single custom {@link Emoji Emote} as button choices.
         *
         ...
         *
         * <p>Any non-unicode {@link Emoji Emote}s should be
         * added using {@link Builder#addChoices(Emoji...)
        ...
        /**
         * Adds custom {@link Emoji Emote}s as button choices.
         *
         * <p>Any regular unicode emojis should be added using {@link
         * Builder#addChoices(String...)
         ...
         *
         * <p>Any non-unicode {@link Emoji Emote}s should be
         * set using {@link Builder#setChoices(Emoji...)
        ...
        /**
         * Sets the {@link Emoji Emote}s as button choices.
         *
         * <p>Any regular unicode emojis should be set using {@link
         * Builder#setChoices(String...)
