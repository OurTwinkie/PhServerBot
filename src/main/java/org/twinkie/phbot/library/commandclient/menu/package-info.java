...
/**
 * Menus package.<br>
 * Contains the {@link org.twinkie.phbot.library.commandclient.menu.Menu Menu} class and all
 * standard implementations of it:
 * <ul>
 *     <li>{@link org.twinkie.phbot.library.commandclient.menu.ButtonMenu ButtonMenu}
 *     <br>A menu where users select a choice via "reaction-buttons".</li>
 *
 *     <li>{@link org.twinkie.phbot.library.commandclient.menu.OrderedMenu OrderedMenu}
 *     <br>A menu with 1 - 10 ordered items, each with their own reaction to choose them with.</li>
 *
 *     <li>{@link org.twinkie.phbot.library.commandclient.menu.Paginator Paginator}
 *     <br>A menu that paginates a number of items across a number of pages and uses reactions to traverse between them.</li>
 *
 *     <li>{@link org.twinkie.phbot.library.commandclient.menu.SelectionDialog SelectionDialog}
 *     <br>A menu that orders choices and uses a indicator and reactions to choose one of the choices.</li>
 *
 *     <li>{@link org.twinkie.phbot.library.commandclient.menu.Slideshow Slideshow}
 *     <br>A menu similar to the Paginator that displays a picture on each page.</li>
 * </ul>
 *
 * All menus also come with an implementation of a {@link org.twinkie.phbot.library.commandclient.menu.Menu.Builder Menu.Builder}
 ...
 * {@link org.twinkie.phbot.library.commandclient.commons.waiter.EventWaiter EventWaiter}.
 */
