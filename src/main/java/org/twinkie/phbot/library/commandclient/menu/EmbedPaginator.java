...
/**
 * A {@link Menu Menu} implementation, nearly identical to
 * {@link Paginator Paginator}, that displays an individual
 * {@link MessageEmbed MessageEmbed} on each page instead of a list of text items.
 *
...
public class EmbedPaginator extends Menu {
    ...
    /**
     * Begins pagination on page 1 as a new {@link Message Message}
    ...
    /**
     * Begins pagination as a new {@link Message Message}
     ...
     * {@link Message Message}, starting on whatever
     ...
     * a {@link EmbedPaginator EmbedPaginator}.
     *
     * @author Andre_601
     */
    public static class Builder extends Menu.Builder<Builder, EmbedPaginator>
    {
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed when the
        ...
        /**
         * Sets the text of the {@link Message Message} to be displayed relative to the
         ...
         * timeout, and possibly run a provided {@link Runnable Runnable}, if only a single slide is
        ...
        /**
         * Adds the collection of provided {@link MessageEmbed MessageEmbeds} to the list
         ...
         * <br>Use the {@link Paginator Paginator} for more Embed customization,
         ...
         * {@link Builder#setLeftRightText(String, String)} will be invalidated if they were set
