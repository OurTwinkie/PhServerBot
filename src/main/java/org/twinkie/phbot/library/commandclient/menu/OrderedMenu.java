...
/**
 * A {@link org.twinkie.phbot.library.commandclient.menu.Menu Menu} of ordered buttons signified
 * by numbers or letters, each with a reaction linked to it for users to click.
 *
 * <p>Up to ten text choices can be set in the {@link Builder},
 * and additional methods for handling the resulting choice made by a user using the
 * menu may also be attached via the {@link Builder#setSelection(BiConsumer)}
 * and {@link Builder#setCancel(Consumer)} methods.
 *
 * @author John Grosh
 */
public class OrderedMenu extends org.twinkie.phbot.library.commandclient.menu.Menu
{
    ...
    public static class Builder extends Menu.Builder<Builder, OrderedMenu>
    {
        ...
        /**
         * If {@code true}, {@link User User}s can type the number or
