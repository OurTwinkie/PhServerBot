...
public class Slideshow extends java.awt.Menu
{
    ...
    public static class Builder extends Menu.Builder<Builder, Slideshow>
    {
         ...
         * in the {@link Message Message} to be displayed when the
        ...
        /**
         * Sets the description of the {@link net.dv8tion.jda.api.entities.MessageEmbed MessageEmbed}
         * in the {@link Message Message} to be displayed relative to the
         * total page number and the current page as determined by the provided {@link BiFunction BiFunction}.
         * <br>As the page changes, the BiFunction will re-process the current page number and the total
         ...
         * timeout, and possibly run a provided {@link Runnable Runnable}, if only a single slide is available to display.
         *
         * @param  wait
